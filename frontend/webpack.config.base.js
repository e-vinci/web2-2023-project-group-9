...
const DEVELOPMENT_API_BASE_URL = 'https://mortalkeyboard.azurewebsites.net'; // base URL of your local API. Use /api if you want to use webpack proxy, else use http://localhost:3000 (frontend origin http://localhost:8080 shall then be authorized by the API cors)
const PRODUCTION_API_BASE_URL = 'https://mortalkeyboard.azurewebsites.net'; // to be changed to point to the URL of your API
...
module.exports = {
  ...
  devServer: {
    ...
    proxy: {
      '/api': {
        target: 'https://mortalkeyboard.azurewebsites.net', 
        pathRewrite: { '^/api': '' },
      },
    },
  },
